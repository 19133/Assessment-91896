  ...
  while not valid:
    ...
    try:
      ...
      if 0.1 <= response <= 10000:
        # Globalising the rounded_budget so it can be used outside the fucntion.
...
if choice =="drink":
  ...
  while True:
    ...
    amount = item_amount ("How many mililitres of {} would you like? You could purchase 10000ml of {} if you have the money, or 1ml.\n".format(drink_choice, drink_choice),1 ,10000)
...
if choice == "chocolate":
  ...
  while True:
    ...
    amount = item_amount ("How many grams of {} would you like? You could purchase 10000g of {} if you have the money, or 1g.\n".format(chocolate_choice, chocolate_choice),1,10000)
...
# Tell the user their recommmended item 
print()
print("With your budget of ${}, we recommend purchasing: ".format(budget))
recommended_item()
