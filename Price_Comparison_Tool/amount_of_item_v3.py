  ...
  while True:
    ...
    if 1 < amount <= 10000:
      ...
      if budget >= rounded_:
        ...
        change = budget - rounded_
        # round the change
        rounded_change = round(change, 2)
        print()
        print("{}ml of {} will cost ${}".format(rounded_amount, drink_choice, rounded_))
  ...
  while True:
    ...
    if 1< amount <= 10000:
      ...
      if budget >= rounded_:
        ...
        rounded_change = round(change, 2)
        print()
        print("{}g of {} will cost ${}".format(rounded_amount, chocolate_choice, rounded_))
        # if the change == 0, don't tell the user their change.
        if rounded_change == 0:
          # end the loop
          break
