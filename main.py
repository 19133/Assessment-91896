# Error Messages
budget_error = "please enter a number that is greater than 0 but less than 10000"
  ...
  while True:
    ...
    if 0 < amount <= 10000:
      ...
      # if the user's budget is less than the cost of their item, tell the user to enter a new amount and tell them the maximum amount they can purchase.
        ...
        # Program calculates the maximum amount the user can purchase. The  is there because due to rounding issues, the program might sometimes print out an amount that is 1 or 2 mililitres off the actual maximum amount. So to make sure the program isn't lying, we minused it by one.
  ...
  while True:
    ...
    if 0 < amount <= 10000:
      ...
      if budget >= rounded_paying_amount:
        ...
        # Program calculates the maximum amount the user can purchase. The  is there because due to rounding issues, the program might sometimes print out an amount that is 1 or 2 grams off the actual maximum amount. So to make sure the program isn't lying, we minused it by one.
        maximum_amount = budget/price_per_100 *100 
        # round maximum amount to 0dp. I did 0dp becuase 
        rounded_maximum_amount = round(maximum_amount, 0)
