...
if choice == "chocolate":
  ...
  if chocolate_choice == "snickers":
    print("A {} chocolate will cost $1.80 per 100ml".format(drink_choice)
  
  if chocolate_choice == "cadbury":
    print("A {} chocolate will cost $1.83 per 100ml".format(drink_choice) 
  
  if chocolate_choice == "skittles":
    print("A {} chocolate will cost $2.71 per 100ml".format(drink_choice)  
  
  if chocolate_choice == "mars":
    print("A {} chocolate will cost $3.83 per 100ml".format(drink_choice)  
  
  if chocolate_choice == "kit kat":
    print("A {} chocolate will cost $3.38 per 100ml".format(drink_choice)  
  
  if drink_choice == "m&m":
    print("A {} chocolate will cost $2.78 per 100ml".format(drink_choice)  
